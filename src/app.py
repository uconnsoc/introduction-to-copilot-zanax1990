...
# Add more activities to the dictionary
activities.update({
    "Basketball": {
        "description": "Team sport focusing on shooting, dribbling, and court strategies",
    ...
    "Robotics Club": {
        "description": "Build and program robots to compete in challenges and competitions",
